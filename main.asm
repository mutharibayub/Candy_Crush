...
DRAW_YELLOW MACRO x,y
	...
	DRAW_RECT CX, DX, 40,20,0EH
	ADD CX, 10
	ADD DX, 5
	DRAW_RECT CX, DX, 20,10,07H
...
.data
	...
	level2 db 0FFH,0,0,0FFH,0,0,0FFH
